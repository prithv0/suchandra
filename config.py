...
OWNER_ID = int(getenv("OWNER_ID", "6951964535"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Crazzy_music_suport")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Crazzy_music_07")
